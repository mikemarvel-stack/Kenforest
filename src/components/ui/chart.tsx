...
/** Allowlist: only hex, rgb/rgba, hsl/hsla, named colours and CSS vars. */
...
/** Sanitize the chart id so it is safe to embed in a CSS selector. */
    ...
    .map(([theme, prefix]) => {
      const vars = colorConfig
        .map(([key, itemConfig]) => {
          ...
          const color = raw ? sanitizeCssValue(raw) : "";
